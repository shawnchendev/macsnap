...
@Suite struct OCRTests {
    @Test func testOCRRecognition() async throws {
        // Create an image with text "Hello Opensnap OCR"
        let width = 400
        let height = 100
        ...
        let str = NSAttributedString(string: "Hello Opensnap OCR", attributes: [
            .font: font,
        ...
        #expect(text.contains("Hello") || text.contains("Opensnap") || text.contains("OCR"))
    }
}
